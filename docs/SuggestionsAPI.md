...
# **getSuggestions**
```swift
    open class func getSuggestions(userId: String, mediaType: [String]? = nil, type: [BaseItemKind]? = nil, startIndex: Int? = nil, limit: Int? = nil, enableTotalRecordCount: Bool? = nil, completion: @escaping (_ data: BaseItemDtoQueryResult?, _ error: Error?) -> Void)
```
...
let type = [BaseItemKind()] // [BaseItemKind] | The type. (optional)
 ...
 **type** | [**[BaseItemKind]**](BaseItemKind.md) | The type. | [optional] 
