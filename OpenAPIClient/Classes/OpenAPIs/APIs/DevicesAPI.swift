...
open class DevicesAPI {
    ...
    /**
     ...
     - parameter id: (query) Device Id. 
     - parameter UNKNOWN_BASE_TYPE: (body) Device Options. 
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateDeviceOptions(id: String, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        updateDeviceOptionsWithRequestBuilder(id: id, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateDeviceOptionsWithRequestBuilder(id: String, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE) -> RequestBuilder<Void> {
        let path = "/Devices/Options"
        let URLString = OpenAPIClientAPI.basePath + path
