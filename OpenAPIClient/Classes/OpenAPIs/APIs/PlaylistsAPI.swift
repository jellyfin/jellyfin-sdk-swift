...
open class PlaylistsAPI {
    ...
    /**
     ...
     - parameter UNKNOWN_BASE_TYPE: (body) The create playlist payload. (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func createPlaylist(name: String? = nil, ids: [UUID]? = nil, userId: UUID? = nil, mediaType: String? = nil, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: PlaylistCreationResult?, _ error: Error?) -> Void)) {
        createPlaylistWithRequestBuilder(name: name, ids: ids, userId: userId, mediaType: mediaType, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE).execute(apiResponseQueue) { result -> Void in
            switch result {
     ...
     */
    open class func createPlaylistWithRequestBuilder(name: String? = nil, ids: [UUID]? = nil, userId: UUID? = nil, mediaType: String? = nil, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE? = nil) -> RequestBuilder<PlaylistCreationResult> {
        let path = "/Playlists"
        let URLString = OpenAPIClientAPI.basePath + path
