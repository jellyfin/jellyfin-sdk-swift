...
open class SessionAPI {
    ...
    /**
     ...
     - parameter UNKNOWN_BASE_TYPE: (body) The MediaBrowser.Model.Session.ClientCapabilities. 
     - parameter id: (query) The session id. (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postFullCapabilities(UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE, id: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        postFullCapabilitiesWithRequestBuilder(UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE, id: id).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func postFullCapabilitiesWithRequestBuilder(UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE, id: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter sessionId: (path) The session id. 
     - parameter UNKNOWN_BASE_TYPE: (body) The MediaBrowser.Model.Session.GeneralCommand. 
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sendFullGeneralCommand(sessionId: String, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        sendFullGeneralCommandWithRequestBuilder(sessionId: sessionId, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func sendFullGeneralCommandWithRequestBuilder(sessionId: String, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter sessionId: (path) The session id. 
     - parameter UNKNOWN_BASE_TYPE: (body) The MediaBrowser.Model.Session.MessageCommand object containing Header, Message Text, and TimeoutMs. 
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sendMessageCommand(sessionId: String, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
        sendMessageCommandWithRequestBuilder(sessionId: sessionId, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE).execute(apiResponseQueue) { result -> Void in
            switch result {
            case .success:
                completion((), nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func sendMessageCommandWithRequestBuilder(sessionId: String, UNKNOWN_BASE_TYPE: UNKNOWN_BASE_TYPE) -> RequestBuilder<Void> {
