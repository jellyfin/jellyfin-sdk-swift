...
extension Paths {
    ...
    static public func getHlsVideoSegment(itemID: String, playlistID: String, segmentID: Int, container: String, parameters: GetHlsVideoSegmentParameters) -> Request<Data> {
        Request(method: "GET", url: "/Videos/\(itemID)/hls1/\(playlistID)/\(segmentID).\(container)", query: parameters.asQuery, id: "GetHlsVideoSegment")
    }
