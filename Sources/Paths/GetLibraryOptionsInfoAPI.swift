...
extension Paths {
    ...
    public static func getLibraryOptionsInfo(
        libraryContentType: CollectionType? = nil,
        isNewLibrary: Bool? = nil
    ) -> Request<LibraryOptionsResultDto> {
        Request(
    ...
    private static func makeGetLibraryOptionsInfoQuery(_ libraryContentType: CollectionType?, _ isNewLibrary: Bool?) -> [(
        String,
        String?
    )] {
