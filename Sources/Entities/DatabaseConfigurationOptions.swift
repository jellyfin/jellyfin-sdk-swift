...
public struct DatabaseConfigurationOptions: Codable, Hashable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.databaseType = try values.decode(String.self, forKey: "DatabaseType")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encode(databaseType, forKey: "DatabaseType")
