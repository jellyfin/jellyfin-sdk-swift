...
public struct NetworkConfiguration: Codable {
    ...
    public init(isAutoDiscovery: Bool? = nil, isAutoDiscoveryTracing: Bool? = nil, baseURL: String? = nil, certificatePassword: String? = nil, certificatePath: String? = nil, enableHTTPS: Bool? = nil, enableIPV4: Bool? = nil, enableIPV6: Bool? = nil, enableMultiSocketBinding: Bool? = nil, enablePublishedServerUriByRequest: Bool? = nil, enableRemoteAccess: Bool? = nil, enableSSDPTracing: Bool? = nil, enableUPnP: Bool? = nil, gatewayMonitorPeriod: Int? = nil, hDHomerunPortRange: String? = nil, httpserverPortNumber: Int? = nil, httpsPortNumber: Int? = nil, isIgnoreVirtualInterfaces: Bool? = nil, isRemoteIPFilterBlacklist: Bool? = nil, knownProxies: [String]? = nil, localNetworkAddresses: [String]? = nil, localNetworkSubnets: [String]? = nil, publicHTTPSPort: Int? = nil, publicPort: Int? = nil, publishedServerUriBySubnet: [String]? = nil, remoteIPFilter: [String]? = nil, requireHTTPS: Bool? = nil, sSDPTracingFilter: String? = nil, isTrustAllIP6Interfaces: Bool? = nil, uDPPortRange: String? = nil, uDPSendCount: Int? = nil, uDPSendDelay: Int? = nil, isUPnPCreateHTTPPortMap: Bool? = nil, virtualInterfaceNames: String? = nil) {
