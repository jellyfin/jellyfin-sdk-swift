...
/// Sessions message.
public struct SessionsMessage: Codable, Hashable, Sendable {
    /// Gets or sets the data.
    public var data: [SessionInfoDto]?
    /// Gets or sets the message id.
    public var messageID: String?
    /// The different kinds of messages that are used in the WebSocket api.
    public var messageType: SessionMessageType?

    public init(data: [SessionInfoDto]? = nil, messageID: String? = nil, messageType: SessionMessageType? = nil) {
        self.data = data
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try values.decodeIfPresent([SessionInfoDto].self, forKey: "Data")
