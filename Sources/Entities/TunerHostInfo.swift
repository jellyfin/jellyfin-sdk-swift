...
public struct TunerHostInfo: Codable, Identifiable {
    ...
    public init(allowHWTranscoding: Bool? = nil, deviceID: String? = nil, enableStreamLooping: Bool? = nil, friendlyName: String? = nil, id: String? = nil, isImportFavoritesOnly: Bool? = nil, source: String? = nil, tunerCount: Int? = nil, type: String? = nil, url: String? = nil, userAgent: String? = nil) {
