...
public struct PlaylistDto: Codable, Hashable, Sendable {
    ...
    public init(isOpenAccess: Bool? = nil, itemIDs: [String], shares: [PlaylistUserPermissions]) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.itemIDs = try values.decode([String].self, forKey: "ItemIds")
        self.shares = try values.decode([PlaylistUserPermissions].self, forKey: "Shares")
    }

    public func encode(to encoder: Encoder) throws {
        var values = encoder.container(keyedBy: StringCodingKey.self)
        try values.encodeIfPresent(isOpenAccess, forKey: "OpenAccess")
        try values.encode(itemIDs, forKey: "ItemIds")
        try values.encode(shares, forKey: "Shares")
    }
}
