...
public struct UserItemDataDto: Codable {
    ...
    public init(isFavorite: Bool? = nil, itemID: String? = nil, key: String? = nil, lastPlayedDate: Date? = nil, isLikes: Bool? = nil, playCount: Int? = nil, playbackPositionTicks: Int? = nil, isPlayed: Bool? = nil, playedPercentage: Double? = nil, rating: Double? = nil, unplayedItemCount: Int? = nil) {
