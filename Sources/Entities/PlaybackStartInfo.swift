...
public struct PlaybackStartInfo: Codable {
    ...
    public init(aspectRatio: String? = nil, audioStreamIndex: Int? = nil, brightness: Int? = nil, canSeek: Bool? = nil, isMuted: Bool? = nil, isPaused: Bool? = nil, item: BaseItemDto? = nil, itemID: UUID? = nil, liveStreamID: String? = nil, mediaSourceID: String? = nil, nowPlayingQueue: [QueueItem]? = nil, playMethod: PlayMethod? = nil, playSessionID: String? = nil, playbackStartTimeTicks: Int? = nil, playlistItemID: String? = nil, positionTicks: Int? = nil, repeatMode: RepeatMode? = nil, sessionID: String? = nil, subtitleStreamIndex: Int? = nil, volumeLevel: Int? = nil) {
