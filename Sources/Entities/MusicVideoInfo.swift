...
public struct MusicVideoInfo: Codable {
    ...
    public init(artists: [String]? = nil, indexNumber: Int? = nil, isAutomated: Bool? = nil, metadataCountryCode: String? = nil, metadataLanguage: String? = nil, name: String? = nil, originalTitle: String? = nil, parentIndexNumber: Int? = nil, path: String? = nil, premiereDate: Date? = nil, providerIDs: [String: String]? = nil, year: Int? = nil) {
