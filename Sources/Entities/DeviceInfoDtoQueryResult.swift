...
public struct DeviceInfoDtoQueryResult: Codable, Hashable, Sendable {
    /// Gets or sets the items.
    public var items: [DeviceInfoDto]?
    /// Gets or sets the index of the first record in Items.
    public var startIndex: Int?
    /// Gets or sets the total number of records available.
    public var totalRecordCount: Int?

    public init(items: [DeviceInfoDto]? = nil, startIndex: Int? = nil, totalRecordCount: Int? = nil) {
        self.items = items
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.items = try values.decodeIfPresent([DeviceInfoDto].self, forKey: "Items")
