...
public struct RemoteSubtitleInfo: Codable, Identifiable {
    ...
    public init(author: String? = nil, comment: String? = nil, communityRating: Double? = nil, dateCreated: Date? = nil, downloadCount: Int? = nil, format: String? = nil, id: String? = nil, isHashMatch: Bool? = nil, name: String? = nil, providerName: String? = nil, threeLetterISOLanguageName: String? = nil) {
        self.author = author
