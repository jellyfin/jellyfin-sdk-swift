...
public final class RemoteSearchResult: Codable {
    ...
    public init(albumArtist: RemoteSearchResult? = nil, artists: [RemoteSearchResult]? = nil, imageURL: String? = nil, indexNumber: Int? = nil, indexNumberEnd: Int? = nil, name: String? = nil, overview: String? = nil, parentIndexNumber: Int? = nil, premiereDate: Date? = nil, productionYear: Int? = nil, providerIDs: [String: String]? = nil, searchProviderName: String? = nil) {
