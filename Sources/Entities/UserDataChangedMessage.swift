...
public struct UserDataChangedMessage: Codable, Hashable, Sendable {
    /// Class UserDataChangeInfo.
    public var data: UserDataChangeInfo?
    /// Gets or sets the message id.
    public var messageID: String?
    /// The different kinds of messages that are used in the WebSocket api.
    public var messageType: SessionMessageType?

    public init(data: UserDataChangeInfo? = nil, messageID: String? = nil, messageType: SessionMessageType? = nil) {
        self.data = data
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try values.decodeIfPresent(UserDataChangeInfo.self, forKey: "Data")
