...
public struct PlayRequest: Codable {
    ...
    public init(audioStreamIndex: Int? = nil, controllingUserID: UUID? = nil, itemIDs: [UUID]? = nil, mediaSourceID: String? = nil, playCommand: PlayCommand? = nil, startIndex: Int? = nil, startPositionTicks: Int? = nil, subtitleStreamIndex: Int? = nil) {
