...
public struct UserUpdatedMessage: Codable, Hashable, Sendable {
    /// Class UserDto.
    ...
    public init(data: UserDto? = nil, messageID: String? = nil, messageType: SessionMessageType? = nil) {
        self.data = data
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.data = try values.decodeIfPresent(UserDto.self, forKey: "Data")
