...
public struct PlaybackInfoDto: Codable {
    ...
    public init(allowAudioStreamCopy: Bool? = nil, allowVideoStreamCopy: Bool? = nil, audioStreamIndex: Int? = nil, isAutoOpenLiveStream: Bool? = nil, deviceProfile: DeviceProfile? = nil, enableDirectPlay: Bool? = nil, enableDirectStream: Bool? = nil, enableTranscoding: Bool? = nil, liveStreamID: String? = nil, maxAudioChannels: Int? = nil, maxStreamingBitrate: Int? = nil, mediaSourceID: String? = nil, startTimeTicks: Int? = nil, subtitleStreamIndex: Int? = nil, userID: UUID? = nil) {
