...
public struct PlayerStateInfo: Codable {
    ...
    public init(audioStreamIndex: Int? = nil, canSeek: Bool? = nil, isMuted: Bool? = nil, isPaused: Bool? = nil, liveStreamID: String? = nil, mediaSourceID: String? = nil, playMethod: PlayMethod? = nil, positionTicks: Int? = nil, repeatMode: RepeatMode? = nil, subtitleStreamIndex: Int? = nil, volumeLevel: Int? = nil) {
