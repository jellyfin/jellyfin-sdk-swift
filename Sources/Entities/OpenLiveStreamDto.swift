...
public struct OpenLiveStreamDto: Codable {
    ...
    public init(audioStreamIndex: Int? = nil, deviceProfile: DeviceProfile? = nil, directPlayProtocols: [MediaProtocol]? = nil, enableDirectPlay: Bool? = nil, enableDirectStream: Bool? = nil, itemID: UUID? = nil, maxAudioChannels: Int? = nil, maxStreamingBitrate: Int? = nil, openToken: String? = nil, playSessionID: String? = nil, startTimeTicks: Int? = nil, subtitleStreamIndex: Int? = nil, userID: UUID? = nil) {
