...
public struct MediaStream: Codable {
    ...
    public init(aspectRatio: String? = nil, averageFrameRate: Double? = nil, bitDepth: Int? = nil, bitRate: Int? = nil, blPresentFlag: Int? = nil, channelLayout: String? = nil, channels: Int? = nil, codec: String? = nil, codecTag: String? = nil, codecTimeBase: String? = nil, colorPrimaries: String? = nil, colorRange: String? = nil, colorSpace: String? = nil, colorTransfer: String? = nil, comment: String? = nil, deliveryMethod: SubtitleDeliveryMethod? = nil, deliveryURL: String? = nil, displayTitle: String? = nil, dvBlSignalCompatibilityID: Int? = nil, dvLevel: Int? = nil, dvProfile: Int? = nil, dvVersionMajor: Int? = nil, dvVersionMinor: Int? = nil, elPresentFlag: Int? = nil, height: Int? = nil, index: Int? = nil, isAVC: Bool? = nil, isAnamorphic: Bool? = nil, isDefault: Bool? = nil, isExternal: Bool? = nil, isExternalURL: Bool? = nil, isForced: Bool? = nil, isInterlaced: Bool? = nil, isTextSubtitleStream: Bool? = nil, language: String? = nil, level: Double? = nil, localizedDefault: String? = nil, localizedExternal: String? = nil, localizedForced: String? = nil, localizedUndefined: String? = nil, nalLengthSize: String? = nil, packetLength: Int? = nil, path: String? = nil, pixelFormat: String? = nil, profile: String? = nil, realFrameRate: Double? = nil, refFrames: Int? = nil, rpuPresentFlag: Int? = nil, sampleRate: Int? = nil, score: Int? = nil, isSupportsExternalStream: Bool? = nil, timeBase: String? = nil, title: String? = nil, type: MediaStreamType? = nil, videoDoViTitle: String? = nil, videoRange: String? = nil, videoRangeType: String? = nil, width: Int? = nil) {
