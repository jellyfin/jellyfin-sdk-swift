...
public struct MediaStream: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.averageFrameRate = try values.decodeIfPresent(Double.self, forKey: "AverageFrameRate")
        ...
        self.realFrameRate = try values.decodeIfPresent(Double.self, forKey: "RealFrameRate")
