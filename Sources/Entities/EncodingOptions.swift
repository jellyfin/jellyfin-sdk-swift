...
public struct EncodingOptions: Codable, Hashable {
    ...
    public var allowMjpegEncoding: Bool?
    ...
    public init(
        ...
        self.allowMjpegEncoding = allowMjpegEncoding
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.allowMjpegEncoding = try values.decodeIfPresent(Bool.self, forKey: "AllowMjpegEncoding")
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encodeIfPresent(allowMjpegEncoding, forKey: "AllowMjpegEncoding")
