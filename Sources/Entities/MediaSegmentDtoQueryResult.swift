...
public struct MediaSegmentDtoQueryResult: Codable, Hashable {
    ...
    public init(items: [MediaSegmentDto]? = nil, startIndex: Int? = nil, totalRecordCount: Int? = nil) {
        self.items = items
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.items = try values.decodeIfPresent([MediaSegmentDto].self, forKey: "Items")
