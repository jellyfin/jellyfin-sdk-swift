...
public struct FolderStorageDto: Codable, Hashable, Sendable {
    ...
    public init(deviceID: String? = nil, freeSpace: Int? = nil, path: String, storageType: String? = nil, usedSpace: Int? = nil) {
