...
open class PersonsAPI {
    ...
    open class func getPerson(name: String, userId: String? = nil) -> AnyPublisher<BaseItemDto, Error> {
        var requestTask: RequestTask?
        return Future<BaseItemDto, Error> { promise in
            requestTask = getPersonWithRequestBuilder(name: name, userId: userId).execute { result in
                switch result {
