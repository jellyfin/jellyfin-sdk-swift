...
open class PluginsAPI {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func updatePluginSecurityInfo(pluginSecurityInfo: PluginSecurityInfo, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) {
