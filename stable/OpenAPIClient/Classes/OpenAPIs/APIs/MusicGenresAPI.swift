...
open class MusicGenresAPI {
     ...
     */
    open class func getMusicGenre(genreName: String, userId: UUID? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: BaseItemDto?, _ error: Error?) -> Void)) {
